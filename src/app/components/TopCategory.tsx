...
function TopCategories() {
  const categories = [
    { id: 1, img: "/t1.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/t2.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/t3.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/t1.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
